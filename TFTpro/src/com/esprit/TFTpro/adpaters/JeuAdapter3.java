 ...
 * @author Taha
 */
public class JeuAdapter3 extends AbstractTableModel{
      List<jeu> jeux;
    
    String[] data = {"Id","match1","match2","match3","match4","match5","match6","match7","match8","match9","match10","Cagnotte","Nbr Gagnant"};
  public JeuAdapter3() {
      
        jeux = new jeuDAO().select4();
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        switch (columnIndex) {
            ...
            return jeux.get(rowIndex).getCagnotte();
                                                          case 12:
            return jeux.get(rowIndex).getNbGagnant();
