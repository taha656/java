...
import com.esprit.TFTpro.adpaters.SesArbAdapter;

import com.esprit.TFTpro.adpaters.SessionAdapter;
 ...
 * @author lenovo
 */
public class ListSes extends javax.swing.JFrame {
    private Connection connection;
    List<Session> listArb= new ArrayList<>();
public List<Session> getList() {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Arbitre", "Durée", "Date_debut", "Date_fin", "Type", "Lieu"
            }
        ));
   ...
   SessionDAO sesDAO = new SessionDAO();
        ...
        listArb = sesDAO.select1();
        SesArbAdapter s = new SesArbAdapter();
        jTable1.setModel(s);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListSes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
